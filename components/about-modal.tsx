        ...
        <div className="space-y-4 mt-4">
          <div>
            ...
            <p className="text-gray-300">
              50 Shades of Your Essay is an AI-powered, futuristic platform where you upload an image, and the websites
              writes you a custom essay describing it. No more boring essays—just pure  genius, with some serious
              hip-hop culture sprinkled in. Also Learn some rizz while essay is being genreated.
            </p>
          </div>
          ...
          <div className="pt-4 border-t border-gray-800">
            <p className="text-sm text-gray-400">Powered by GOD&apos;and Me</p>
          </div>
        </div>
      </DialogContent>
    </Dialog>
